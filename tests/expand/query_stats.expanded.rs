            ...
            .await?
        {
            results
                .push(CompressedQueryStats {
                    ...
                    collected_at: if fields.collected_at {
                        row.get(3usize)
                    } else {
                        Default::default()
                    },
                    collected_secs: if fields.collected_secs {
                        row.get(4usize)
                    } else {
                        Default::default()
                    },
                    fingerprint: if fields.fingerprint {
                        row.get(5usize)
                    } else {
                        Default::default()
                    },
                    postgres_role_id: if fields.postgres_role_id {
                        row.get(6usize)
                    } else {
                        Default::default()
                    },
                    ...
                    rows: if fields.rows { row.get(8usize) } else { Default::default() },
                    total_time: if fields.total_time {
                        row.get(9usize)
                    } else {
                        Default::default()
                    },
                    io_time: if fields.io_time {
                        row.get(10usize)
                    } else {
                        Default::default()
                    },
                    shared_blks_hit: if fields.shared_blks_hit {
                        row.get(11usize)
                    } else {
                        Default::default()
                    },
                    shared_blks_read: if fields.shared_blks_read {
                        row.get(12usize)
                    } else {
                        Default::default()
                    },
